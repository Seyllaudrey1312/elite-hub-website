            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between items-center flex-wrap gap-4">
                    ...
                    <div class="flex gap-3">
                        <img src="../assets/images/logos/EMG logo.jpg" alt="EMG logo.jpg" class="h-10 w-13 rounded">
                        <img src="../assets/images/logos/TGV logo.jpg" alt="TGV logo.jpg" class="h-10 w-13 rounded">
                    </div>
                </div>
            </div>
        </footer>
